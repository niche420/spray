...
// layer's internals just to draw their panels for them. If/when a path
// tracer or splat viewer render path is added, splitting "scene
// simulation" (stays here) from "which renderer draws it" is the natural
// seam -- not attempted preemptively.
...
private:
    ...
    char m_loadPathBuffer[256] = "assets/startup/DamagedHelmet.glb";
};
